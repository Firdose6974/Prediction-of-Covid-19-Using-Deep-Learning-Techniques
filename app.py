...
label_dict={0:'Covid Postitive', 1:'Normal', 2: 'Pneumonia'}
...
def predict():
    ...
    try:
        ...
        response = {'prediction': {'success': True,'result': label,'accuracy': accuracy}}
        
        return jsonify(response)
    except:
        print("Error has occured")
        response = {'prediction': {'success': False,'result': "0",'accuracy': "0"}}
        return jsonify(response)
